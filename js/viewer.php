...
<head>
    ...
    <link rel="stylesheet" href="<?php echo JWB.'magazine-js/';?>pdfjs/viewer.css"/>
    <link rel="stylesheet" href="<?php echo JWB.'magazine-js/';?>pdf-flip.css"/>
    <style>
        .se-pre-con {
            position: fixed;
            left: 0px;
            ...
            height: 100%;
            z-index: 9999;
            background: url(<?php echo JWB.'magazine-js/';?>pics/loader.gif) center no-repeat #fff;
        }
    </style>
</head>
...
<script src="<?php echo JWB.'magazine-js/';?>pdfjs/compatibility.js"></script>
<!-- This snippet is used in production (included from viewer.html) -->
<link rel="resource" type="application/l10n" href="<?php echo JWB.'magazine-js/';?>pdfjs/locale/locale.properties"/>
<script src="<?php echo JWB;?>jquery.js"></script>
<script src="<?php echo JWB.'magazine-js/';?>turnjs/turn.min.js"></script>
<script src="<?php echo JWB.'magazine-js/';?>turnjs/zoom.min.js"></script>
<script src="<?php echo JWB.'magazine-js/';?>pdfjs/l10n.js"></script>
<script src="<?php echo JWB.'magazine-js/';?>pdfjs/build/pdf.js"></script>
<script src="<?php echo JWB.'magazine-js/';?>pdfjs/debugger.js"></script>
<script type="text/javascript">
    // Modifications by Drajat Hasan
    var DEFAULT_URL =  "<?php echo $file_loc_url; ?>";
    // End Modifications
</script>
<script src="<?php echo JWB.'magazine-js/';?>pdfjs/viewer.js"></script>
<script src="<?php echo JWB.'magazine-js/';?>pdf-flip.js?v=1.1.1.1.1.1"></script>
<script type="text/javascript">
