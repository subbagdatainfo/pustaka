...
$sysconf['print']['barcode']['barcode_include_header_text'] = 2; // change to 0 if dont want to use header in each barcode
...
$sysconf['print']['membercard']['stamp_file'] = ""; // stamp image, use transparent image
$sysconf['print']['membercard']['signature_file'] = ""; // sign picture, use transparent image
...
$sysconf['print']['membercard']['barcode_width'] = "9";
$sysconf['print']['membercard']['barcode_height'] = "4.5";
