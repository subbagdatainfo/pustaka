...
if (isset($_GET['action']) AND $_GET['action'] == 'print') {
	...
	*/
    ...
    $html_str .= '.city{z-index:13;font-size:9px;top: -12px;margin-left: -10px;}'."\n";
    $html_str .= '.title{z-index:14;font-size:9px;top: -12px;margin-left:-10px;}'."\n";
    $html_str .= '.officials{z-index:15;top: -12px;font-size: 9px;margin-left: -10px;}'."\n";
    ...
    $html_str .= '.exp_div{z-index:18;position: absolute;left: 205px;top: 135px;width:110px;height: 12px;font-size: 8px;text-align: right;}'."\n";
    $html_str .= '.barcode_div{z-index:19;position: absolute;right :-10px;top: 150px;width: 110px;height: 45px;}'."\n";
    $html_str .= '</style>'."\n";
    $html_str .= '</head>'."\n";
    $html_str .= '<body>'."\n";
