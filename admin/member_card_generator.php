...
if (isset($_GET['action']) AND $_GET['action'] == 'print') {
	...
	*/
    ...
    $html_str .= '.bio_div{z-index:7;position: absolute;left: 0px;top:60px;height: 110px;margin: 0px;text-align: justify;}'."\n";
    ...
    $html_str .= '.exp_div{z-index:18;position: absolute;right : 14px;top: 135px;width:100px;height: 12px;font-size: 8px;text-align: right;}'."\n";
    $html_str .= '.barcode_div{z-index:19;position: absolute;right : 17px;top: 150px;width: 100px;height: 60px;}'."\n";
    $html_str .= '</style>'."\n";
    $html_str .= '</head>'."\n";
    $html_str .= '<body>'."\n";
